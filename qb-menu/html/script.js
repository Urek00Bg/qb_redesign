...
//Live server edit remove comments
/*
openMenu([
    { header: "Test Button", txt: "This is working.", icon: "" },
    { header: "Disabled Button", text: "Example desc.", disabled: true },
    { header: "Menu Header", isMenuHeader: true }
]);
*/